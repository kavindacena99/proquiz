...
create table quizzes(qid INT primary key auto_increment,question text,options text,correct_option INT,category varchar(50),qlang varchar(25),createdby INT default 0,userid INT default 0);
