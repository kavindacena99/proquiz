...
<?php
    ...
    if(isset($_POST['put'])){
        ...
        $sql = "INSERT INTO quizpool (question,options,correct_option,category,qlang,approved,userid) VALUES('{$quiz}','{$options}','$correctoption','{$category}','{$lang}',0,$user)";
        $result = $connection->query($sql);

        if($result){
            echo "<script>alert('Quiz added successfully!')</script>";
            header("Location: myquizes.php");
        }else{
...
<body>
    ...
    <div class="container" style="margin-top: 30px;margin-bottom:10px;">
        ...
        <form action="putquiz.php" method="post" class="col-md-11" style="margin-left: 50px;margin-right:50px">
            <div class="mb-3">
